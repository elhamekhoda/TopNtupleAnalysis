...
int main(int argc, char **argv) {
  ...
  if (runMM){ // >= 2 jets
	MM_0b_re      = new MMUtils("scripts/QCDestimation/290616_realRates_re_0b/eff_ttbar.root",     "scripts/QCDestimation/130716_fakeRates_re_0b/fake.root");
	MM_1b_re      = new MMUtils("scripts/QCDestimation/290616_realRates_re_in1b/eff_ttbar.root",   "scripts/QCDestimation/130716_fakeRates_re_in1b/fake.root");
