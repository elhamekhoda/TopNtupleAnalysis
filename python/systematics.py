...
def get_systs(expr, isTtbar, isSingleTop, isWjets, EFT, pdfList, pdfSumOfWeights, ttbarHighOrderCorrection, applyQCD, analysis = None):
    ...
    if expr[0:3] == 'all':
        systList.extend([
            ...
            # 'CombMass_medium_JETComb_Baseline_Kin__1up',
            # 'CombMass_medium_JETComb_Baseline_Kin__1down',
            # 'CombMass_medium_JETComb_Modelling_Kin__1up',
            # 'CombMass_medium_JETComb_Modelling_Kin__1down',
            # 'CombMass_medium_JETComb_TotalStat_Kin__1up',
            # 'CombMass_medium_JETComb_TotalStat_Kin__1down',
            # 'CombMass_medium_JETComb_Tracking_Kin__1up',
            # 'CombMass_medium_JETComb_Tracking_Kin__1down',
            # 'CombMass_medium_JETRtrk_Baseline_Sub__1up',
            # 'CombMass_medium_JETRtrk_Baseline_Sub__1down',
            # 'CombMass_medium_JETRtrk_Modelling_Sub__1up',
            # 'CombMass_medium_JETRtrk_Modelling_Sub__1down',
            # 'CombMass_medium_JETRtrk_TotalStat_Sub__1up',
            # 'CombMass_medium_JETRtrk_TotalStat_Sub__1down',
            # 'CombMass_medium_JETRtrk_Tracking_Sub__1up',
            # 'CombMass_medium_JETRtrk_Tracking_Sub__1down',
...
ALLSYSTS = OrderedDict((
    ...
    _syst('CombMass_medium_JETComb_Baseline_Kin__1down'), 
    _syst('CombMass_medium_JETComb_Baseline_Kin__1up'), 
    _syst('CombMass_medium_JETComb_Modelling_Kin__1down'), 
    _syst('CombMass_medium_JETComb_Modelling_Kin__1up'), 
    _syst('CombMass_medium_JETComb_TotalStat_Kin__1down'), 
    _syst('CombMass_medium_JETComb_TotalStat_Kin__1up'), 
    _syst('CombMass_medium_JETComb_Tracking_Kin__1down'), 
    _syst('CombMass_medium_JETComb_Tracking_Kin__1up'), 
    _syst('CombMass_medium_JETRtrk_Baseline_Sub__1down'), 
    _syst('CombMass_medium_JETRtrk_Baseline_Sub__1up'), 
    _syst('CombMass_medium_JETRtrk_Modelling_Sub__1down'), 
    _syst('CombMass_medium_JETRtrk_Modelling_Sub__1up'), 
    _syst('CombMass_medium_JETRtrk_TotalStat_Sub__1down'), 
    _syst('CombMass_medium_JETRtrk_TotalStat_Sub__1up'), 
    _syst('CombMass_medium_JETRtrk_Tracking_Sub__1down'), 
    _syst('CombMass_medium_JETRtrk_Tracking_Sub__1up'), 
