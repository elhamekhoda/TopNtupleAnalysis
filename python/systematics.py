...
ALLSYSTS = OrderedDict((
    ...
    _syst('JET_Flavor_Composition_prop__1up'),
    _syst('JET_Flavor_Response_prop__1up'),
    _syst('JET_Flavour_PerJet_Hadronization_HF__1up'),
    _syst('JET_Flavour_PerJet_Hadronization__1up'),
    _syst('JET_Flavour_PerJet_GenShower__1up'),
    _syst('JET_Flavour_PerJet_GenShower_HF__1up'),
    _syst('JET_Flavour_PerJet_Shower__1up'),
    _syst('JET_Flavour_PerJet_Shower_HF__1up'),
    ...
    _syst('JET_Flavor_Composition_prop__1down'),
    _syst('JET_Flavor_Response_prop__1down'),
    _syst('JET_Flavour_PerJet_Hadronization_HF__1down'),
    _syst('JET_Flavour_PerJet_Hadronization__1down'),
    _syst('JET_Flavour_PerJet_GenShower__1down'),
    _syst('JET_Flavour_PerJet_GenShower_HF__1down'),
    _syst('JET_Flavour_PerJet_Shower__1down'),
    _syst('JET_Flavour_PerJet_Shower_HF__1down'),
    ...
    _syst('MUON_CB__1down'),
    _syst('MUON_CB__1up'),
    _syst('MUON_SAGITTA_RESBIAS__1down'),
    _syst('MUON_SAGITTA_RESBIAS__1up'),
    _syst('MUON_SAGITTA_DATASTAT__1down'),
    _syst('MUON_SAGITTA_DATASTAT__1up'),
