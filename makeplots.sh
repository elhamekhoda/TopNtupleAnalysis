...
for ch in be bmu re rmu be3 bmu3 re3 rmu3 be2 bmu2 re2 rmu2 be1 bmu1 re1 rmu1 beX bmuX reX rmuX ; do
    ...
    $PLOTTING -c $ch -h closestJetPt -l $LUMI --normBinWidth 10 --yTitle "Events / 10 GeV" --xTitle "Selected jet p_{T} [GeV]" --stamp 0 -C config.txt
...
for ch in be bmu re rmu be3 bmu3 re3 rmu3 be2 bmu2 re2 rmu2 be1 bmu1 re1 rmu1 beX bmuX reX rmuX ; do
    $PLOTTING -c $ch -h mtt --mcOnly 1 --normBinWidth 100 --logY 1 --rebin 10 -l $LUMI --xTitle "m_{t#bar{t}}" --yTitle "Events / 100 GeV" --stamp 0 -C config.txt
