...
// 4jets    
     ...
     mm_mu[1*10+4] = new MMUtils(1, runMM_etaCorr_mu, runMM_DRCorr_mu, 
             ...
             data_dir+"QCDestimation/RATES_2015_2016/hist_fake_1btag_4jets_run2r145_rmu.root"); // fake2015+2016+2017+2018
...
//3jets-Ecxlusive
 ...
 mm_mu[1*10+3] = new MMUtils(1, runMM_etaCorr_mu, runMM_DRCorr_mu,       
             data_dir+"QCDestimation/RATES_2015_2016/hist_real_1btag_4jets_run2r145_rmu.root",   // real2015+2016+2017+2018
             data_dir+"QCDestimation/RATES_2015_2016/hist_fake_1btag_3jets_run2r145_rmu.root"); // fake2015+2016+2017+2018
...
//2jets-Exclusive
 ...
 mm_mu[1*10+2] = new MMUtils(1, runMM_etaCorr_mu, runMM_DRCorr_mu,       
             data_dir+"QCDestimation/RATES_2015_2016/hist_real_1btag_4jets_run2r145_rmu.root",   // real2015+2016+2017+2018
             data_dir+"QCDestimation/RATES_2015_2016/hist_fake_1btag_2jets_run2r145_rmu.root"); // fake2015+2016+2017+2018
 }
...
double TopNtupleAnalysisUtils::getQCDWeight(int btags, int boosted, TLorentzVector met, TLorentzVector lep, int isTight, std::vector<TLorentzVector> jet, float sd0, int isElectron, float topoetcone20, int runNumber) {
