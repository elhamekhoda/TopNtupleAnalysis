...
AnaTtresQCD::AnaTtresQCD(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList, int dsid, bool isData)
  ...
  std::string suffix0(""), Njets2_btag0("2jets_btag0_");
  IniHistograms(suffix0, Njets2_btag0);
  std::string suffix1(""), Njets2_btag1("2jets_btag1_");
  IniHistograms(suffix1, Njets2_btag1);
  
  std::string Njets3_btag0("3jets_btag0_");
  IniHistograms(suffix0, Njets3_btag0);
  std::string Njets3_btag1("3jets_btag1_");
  IniHistograms(suffix1, Njets3_btag1);
  
  std::string Njets2or3_btag0("2or3jets_btag0_");
  IniHistograms(suffix0, Njets2or3_btag0);
  std::string Njets2or3_btag1("2or3jets_btag1_");
  IniHistograms(suffix1, Njets2or3_btag1);
  
  std::string Njets4_btag0("4jets_btag0_");
  IniHistograms(suffix0, Njets4_btag0);
  std::string Njets4_btag1("4jets_btag1_");
  IniHistograms(suffix1, Njets4_btag1);
  std::string suffix2(""), Njets4_btag2("4jets_btag2_");
  IniHistograms(suffix2, Njets4_btag2);
...
/*
  ...
  */
  //if(evt.jet().size()<2)	return; 
  
  
  if (!m_boosted)
    if (!( evt.passes("rejetsIncluR_2015") || evt.passes("rmujetsQCDCR_2015") || evt.passes("bejetsIncluR_2015") || evt.passes("bmujetsQCDCR_2015") ))
      return;
  ...
  if (leptMa_pdgId!=0)	{
	...
	if(evt.jet().size() == 2)
	  {
     		if(nTrkBtagged == 0)
     		GetRealHistograms(evt, weight, suffix, "2jets_btag0_");
     		if(nTrkBtagged >= 1)
     		GetRealHistograms(evt, weight, suffix, "2jets_btag1_");
	  }
	else if(evt.jet().size() == 3)
	  {
     		if(nTrkBtagged == 0)
     		GetRealHistograms(evt, weight, suffix, "3jets_btag0_");
     		if(nTrkBtagged >= 1)
     		GetRealHistograms(evt, weight, suffix, "3jets_btag1_");
	  }
	if(evt.jet().size() == 2 || evt.jet().size() == 3)
	  {
     		if(nTrkBtagged == 0)
     		GetRealHistograms(evt, weight, suffix, "2or3jets_btag0_");
     		if(nTrkBtagged >= 1)
     		GetRealHistograms(evt, weight, suffix, "2or3jets_btag1_");
	  }
	else if(evt.jet().size() >= 4)
	  {
     		if(nTrkBtagged == 0)
     		GetRealHistograms(evt, weight, suffix, "4jets_btag0_");
     		if(nTrkBtagged >= 1)
     		GetRealHistograms(evt, weight, suffix, "4jets_btag1_");
     		if(nTrkBtagged >= 2)
     		GetRealHistograms(evt, weight, suffix, "4jets_btag2_");
	  }
...
void AnaTtresQCD::runRealRateQCDCR_2016(const Event &evt, double weight, const std::string &suffix){
  ...
  */
  ...
  if (!m_boosted)
    if (!( evt.passes("rejetsIncluR_2016") || evt.passes("rmujetsQCDCR_2016") || evt.passes("bejetsIncluR_2016") || evt.passes("bmujetsQCDCR_2016") ))
      return;
...
void AnaTtresQCD::GetRealHistograms(const Event &evt, double weight, const std::string &suffix, const std::string &btag){
  ...
  if (closejl_deltaR<99)  {
	...
	h->h1D(btag + "eff_lepEta",  	"", suffix)->Fill(lept.Eta()     , weight);
	...
	{
           h->h2D(btag + "eff_lepPt_topoetcone_lowDR",  "", suffix)->Fill(lept.Pt()*1e-3 ,topoetcone*1e-3 , weight);
	   h->h1D(btag + "eff_lepPt_lowDR",  "", suffix)->Fill(lept.Pt()*1e-3 , weight);
	}
        else
	{
           h->h2D(btag + "eff_lepPt_topoetcone_highDR",  "", suffix)->Fill(lept.Pt()*1e-3 ,topoetcone*1e-3 , weight);
	   h->h1D(btag + "eff_lepPt_highDR",  "", suffix)->Fill(lept.Pt()*1e-3 , weight);
	}
 ...
 */
  ...
  if(evt.jet().size() == 2)
	  {
     		if(nTrkBtagged == 0)
     		GetFakeHistograms(evt, weight, "", suffix, "2jets_btag0_");
     		if(nTrkBtagged >= 1)
     		GetFakeHistograms(evt, weight, "", suffix, "2jets_btag1_");
	  }
  else if(evt.jet().size() == 3)
	  {
     		if(nTrkBtagged == 0)
     		GetFakeHistograms(evt, weight, "", suffix, "3jets_btag0_");
     		if(nTrkBtagged >= 1)
     		GetFakeHistograms(evt, weight, "", suffix, "3jets_btag1_");
	  }
  if(evt.jet().size() == 2 || evt.jet().size() == 3)
	  {
     		if(nTrkBtagged == 0)
     		GetFakeHistograms(evt, weight, "", suffix, "2or3jets_btag0_");
     		if(nTrkBtagged >= 1)
     		GetFakeHistograms(evt, weight, "", suffix, "2or3jets_btag1_");
	  }
   else if(evt.jet().size() >= 4)
	  {
     		if(nTrkBtagged == 0)
     		GetFakeHistograms(evt, weight, "", suffix, "4jets_btag0_");
     		if(nTrkBtagged >= 1)
     		GetFakeHistograms(evt, weight, "", suffix, "4jets_btag1_");
     		if(nTrkBtagged >= 2)
     		GetFakeHistograms(evt, weight, "", suffix, "4jets_btag2_");
	  }
...
void AnaTtresQCD::runFakeRateQCDCR_2016(const Event &evt, double weight, const std::string &suffix){
  ...
  */
  ...
  if (!m_boosted)
    if (!( evt.passes("rejetsIncluR_2016") || evt.passes("rmujetsQCDCR_2016") || evt.passes("bejetsIncluR_2016") || evt.passes("bmujetsQCDCR_2016") ))
    //if (!( ((evt.passes("rejetsIncluR_2016") || evt.passes("rmujetsQCDCR_2016")) && evt.jet().size()>=4) ))
      return;
...
void AnaTtresQCD::GetFakeHistograms(const Event &evt, const double weight, const std::string &prefix, const std::string &suffix, const std::string &btag){
  ...
  if (closejl_deltaR<99){
     ...
     h->h1D(btag +prefix+"fake_lepEta_80bins",  "", suffix)->Fill(lept.Eta()     , weight);
...
void AnaTtresQCD::IniHistograms(std::string &suffix0,  std::string &btag){

  //****Efficiency studies
  
  std::string suffix = btag + suffix0;
  ...
  //Double_t DR_bins_re[]  	= {0., 0.4, 0.6, 1.0, 1.5, 2.5, 7.0};
  Double_t DR_bins_re[]  	= {0., 0.4, 0.5, 0.7, 1.0, 1.5, 2.5, 7.0};
  ...
  Double_t DR_bins_rmu[]        = {0., 0.4, 0.5, 0.7, 1.0, 1.5, 2.5, 7.0};
  ...
  m_hSvc.create1D(suffix+"eff_lepEta",         	"; lepton #eta; Events", 20, -4.0, 4.0);
  ...
  m_hSvc.create1D(suffix+"fake_lepEta_80bins",         		"; lepton #eta; Events", 80, -4.0, 4.0); 
  ...
  if (m_boosted){
	...
	m_hSvc.create1DVar(suffix+"eff_lepPt_lowDR",  	"; lepton p_{T} [GeV]; Events", eff_N_pT_bins, eff_pT_bins_be);
	m_hSvc.create1DVar(suffix+"eff_lepPt_highDR",  	"; lepton p_{T} [GeV]; Events", eff_N_pT_bins, eff_pT_bins_be);
	...
	m_hSvc.create1DVar(suffix+"eff_lepPt_lowDR",  	"; lepton p_{T} [GeV]; Events", eff_N_pT_bins, eff_pT_bins_bmu);
	m_hSvc.create1DVar(suffix+"eff_lepPt_highDR",  	"; lepton p_{T} [GeV]; Events", eff_N_pT_bins, eff_pT_bins_bmu);
	...
	m_hSvc.create1DVar(suffix+"eff_lepPt_lowDR",  	"; lepton p_{T} [GeV]; Events", eff_N_pT_bins, eff_pT_bins_re);
	m_hSvc.create1DVar(suffix+"eff_lepPt_highDR",  	"; lepton p_{T} [GeV]; Events", eff_N_pT_bins, eff_pT_bins_re);
	...
	m_hSvc.create1DVar(suffix+"eff_lepPt_lowDR",  	"; lepton p_{T} [GeV]; Events", eff_N_pT_bins, eff_pT_bins_rmu);
	m_hSvc.create1DVar(suffix+"eff_lepPt_highDR",  	"; lepton p_{T} [GeV]; Events", eff_N_pT_bins, eff_pT_bins_rmu);
