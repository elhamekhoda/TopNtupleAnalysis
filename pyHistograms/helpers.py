...
weightSF = {'' : ['pileup', 'leptonSF', 'jvt', 'indiv_SF_EL_ChargeID', 'indiv_SF_EL_ChargeMisID'],
            'eChargeSF__1up': ['pileup', 'leptonSF', 'jvt', 'indiv_SF_EL_ChargeID_UP', 'indiv_SF_EL_ChargeMisID'],
            'eChargeSF__1down': ['pileup', 'leptonSF', 'jvt', 'indiv_SF_EL_ChargeID_DOWN', 'indiv_SF_EL_ChargeMisID'],
            'eChargeMisIDStatSF__1up': ['pileup', 'leptonSF', 'jvt', 'indiv_SF_EL_ChargeID', 'indiv_SF_EL_ChargeMisID_STAT_UP'],
            'eChargeMisIDStatSF__1down': ['pileup', 'leptonSF', 'jvt', 'indiv_SF_EL_ChargeID', 'indiv_SF_EL_ChargeMisID_STAT_DOWN'],
            'eChargeMisIDSystSF__1up': ['pileup', 'leptonSF', 'jvt', 'indiv_SF_EL_ChargeID', 'indiv_SF_EL_ChargeMisID_SYST_UP'],
            'eChargeMisIDSystSF__1down': ['pileup', 'leptonSF', 'jvt', 'indiv_SF_EL_ChargeID', 'indiv_SF_EL_ChargeMisID_SYST_DOWN'],
            'eTrigSF__1up': ['pileup', 'leptonSF_EL_SF_Trigger_UP', 'jvt', 'indiv_SF_EL_ChargeID', 'indiv_SF_EL_ChargeMisID'],
            'eTrigSF__1down': ['pileup', 'leptonSF_EL_SF_Trigger_DOWN', 'jvt', 'indiv_SF_EL_ChargeID', 'indiv_SF_EL_ChargeMisID'],
