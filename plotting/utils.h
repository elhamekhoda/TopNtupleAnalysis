...
void drawDataMC(SampleSetConfiguration &stackConfig, const vector<std::string> &extraText, const std::string &outfile = "plot.eps", bool ratio = true, const std::string &xTitle = "", const std::string &yTitle = "", bool mustBeBigger = false, int posLegend = 0, float yMin = -1, float yMax = -1, int arrow = 0, double lumi = 5, float xLabelSize = -1, float yLabelSize = -1);
