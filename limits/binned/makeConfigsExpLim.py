...
#fixFile('ttres_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov.config', 'ttres_bkg_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov%s.config' % suf, "bkg_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov%s" %suf, "bkg_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov%s" %suf, True)
#system('cp -f hist_zprime1000.root %s/hist_bkg_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov%s.root' %(mydirin,suf)) ## use a dummy signal for the background only fit
#jobSubmit('bkg_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov%s' %suf)
...
#fixFile('ttres_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_topptnnlo_asimov.config', 'ttres_bkg_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_topptnnlo_asimov%s.config' % suf, "bkg_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_topptnnlo_asimov%s" %suf, "bkg_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_topptnnlo_asimov%s" %suf, True)
#system('cp -f hist_zprime1000.root %s/hist_bkg_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_topptnnlo_asimov%s.root' %(mydirin,suf)) ## use a dummy signal for the background only fit
#jobSubmit('bkg_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_topptnnlo_asimov%s' %suf)
...
for t in signalList:
  ...
  if "kkg" in t and "w" in t:
    continue
  for i in signalList[t]: #[]: #['zprime400', 'zprime1000']: #signalList[t]:
    if i[:2] != 'dm': continue

    fixFile('ttres_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov.config', 'ttres_%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov_stat.config' % (i, suf), i, "%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov_stat" % (i, suf), False)
    jobSubmit('%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov_stat' % (i, suf))

    fixFile('ttres_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov.config', 'ttres_%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov.config' % (i, suf), i, "%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov" % (i, suf), False)
    jobSubmit('%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov' % (i, suf))

    if 'zprime2000' in i or 'zprime3000' in i:
      fixFile('ttres_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov.config', 'ttres_%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov_inj.config' % (i, suf), i, "%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov_inj" % (i, suf), False)
      jobSubmit('%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero2_dectau32_topptnnlo_asimov_inj' % (i, suf))




    #fixFile('ttres_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_dectau32_asimov.config', 'ttres_%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_dectau32_asimov.config' % (i, suf), i, "%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_dectau32_asimov" % (i, suf), False)
    #jobSubmit('%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_dectau32_asimov' % (i, suf))

    #fixFile('ttres_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov.config', 'ttres_%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov.config' % (i, suf), i, "%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov" % (i, suf), False)
    #jobSubmit('%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov' % (i, suf))

    #fixFile('ttres_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov.config', 'ttres_%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov_stat.config' % (i, suf), i, "%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov_stat" % (i, suf), False)
    #jobSubmit('%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov_stat' % (i, suf))

    #if 'zprime2000' in i or 'zprime3000' in i:
    #  fixFile('ttres_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov.config', 'ttres_%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov.config' % (i, suf), i, "%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov" % (i, suf), False)
    #  jobSubmit('%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov' % (i, suf))

    #  fixFile('ttres_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov.config', 'ttres_%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov_inj.config' % (i, suf), i, "%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov_inj" % (i, suf), False)
    #  jobSubmit('%s%s_boottnorm_smooth2nnlottpspp8mbinsqcdfixzero_asimov_inj' % (i, suf))
